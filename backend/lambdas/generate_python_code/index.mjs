...
export const handler = async event => {
  ...
  const modelId  = configuration[`generate_${lang}_code_model`]  || 'amazon.nova-pro-v1:0';
  const basePrompt = configuration[`generate_${lang}_code_prompt`] || `Gere um código ${lang} Hello World.`;
  const control = {
